...
<!-- Graph CSS -->
<link href="${ctx}/modern/css/lines.css" rel='stylesheet' type='text/css' />
...
<!---//webfonts--->  
<!-- Nav CSS -->
<link href="${ctx}/modern/css/custom.css" rel="stylesheet">
<!-- Metis Menu Plugin JavaScript -->
<script src="${ctx}/modern/js/metisMenu.min.js"></script>
<script src="${ctx}/modern/js/custom.js"></script>
<!-- Graph JavaScript -->
<script src="${ctx}/modern/js/d3.v3.js"></script>
<script src="${ctx}/modern/js/rickshaw.js"></script>
</head>
<body>
<div id="wrapper">
     <!-- Navigation -->
            ...
            <ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
	        		...
	        		<ul class="dropdown-menu">
						...
						<li class="avatar">
							<a href="#">
								<img src="${ctx}/modern/images/1.png" alt=""/>
								<div>New message</div>
						...
						<li class="avatar">
							<a href="#">
								<img src="${ctx}/modern/images/2.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
								<span class="label label-info">NEW</span>
							</a>
						...
						<li class="avatar">
							<a href="#">
								<img src="${ctx}/modern/images/3.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
						<li class="avatar">
							<a href="#">
								<img src="${ctx}/modern/images/4.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
						<li class="avatar">
							<a href="#">
								<img src="${ctx}/modern/images/5.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
						<li class="avatar">
							<a href="#">
								<img src="${ctx}/modern/images/pic1.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
			    ...
			    <li class="dropdown">
	        		<a href="#" class="dropdown-toggle avatar" data-toggle="dropdown"><img src="${ctx}/modern/images/1.png"><span class="badge">9</span></a>
	        		<ul class="dropdown-menu">
		       ...
		       <div class="activity_box">
		        <div class="scrollbar" id="style-2">
                   <div class="activity-row">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='${ctx}/modern/images/5.png' class="img-responsive" alt=""/></div>
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='${ctx}/modern/images/3.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
                    ...
                    <div class="activity-row">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='${ctx}/modern/images/1.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
                    ...
                    <div class="activity-row1">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='${ctx}/modern/images/4.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
	  ...
	  <div class="span_11">
		<div class="col-md-6 col_4">
		  ...
		  <!----Calender -------->
			<link rel="stylesheet" href="${ctx}/modern/css/clndr.css" type="text/css" />
			<script src="${ctx}/modern/js/underscore-min.js" type="text/javascript"></script>
			<script src= "${ctx}/modern/js/moment-2.2.1.js" type="text/javascript"></script>
			<script src="${ctx}/modern/js/clndr.js" type="text/javascript"></script>
			<script src="${ctx}/modern/js/site.js" type="text/javascript"></script>
			<!----End Calender -------->
		</div>
...
var detail = new Rickshaw.Graph.HoverDetail({
	graph: graph
	      ...
	      <!-- map -->
<link href="${ctx}/modern/css/jqvmap.css" rel='stylesheet' type='text/css' />
<script src="${ctx}/modern/js/jquery.vmap.js"></script>
<script src="${ctx}/modern/js/jquery.vmap.sampledata.js" type="text/javascript"></script>
<script src="${ctx}/modern/js/jquery.vmap.world.js" type="text/javascript"></script>
