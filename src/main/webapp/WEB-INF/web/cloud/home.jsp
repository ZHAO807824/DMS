...
<link rel="stylesheet" type="text/css" href="${ctx}/cloud/css/themes/default.css"
	id="skin-switcher">
<link rel="stylesheet" type="text/css" href="${ctx}/cloud/css/responsive.css">
<!-- STYLESHEETS -->
...
<body>
	...
	<div class="container">
		<div class="navbar-brand">
			<!-- COMPANY LOGO -->
			<a href="index.html"> <img src="${ctx}/cloud/img/logo/logo.png"
		...
		<ul class="nav navbar-nav pull-right">
			...
			<li class="dropdown" id="header-message"><a href="#"
				...
				<ul class="dropdown-menu inbox">
					...
					<li><a href="#"> <img src="${ctx}/cloud/img/avatars/avatar2.jpg" alt="" />
					...
					<li><a href="#"> <img src="${ctx}/cloud/img/avatars/avatar1.jpg" alt="" />
					...
					<li><a href="#"> <img src="${ctx}/cloud/img/avatars/avatar8.jpg" alt="" />
			...
			<li class="dropdown user" id="header-user"><a href="#"
				class="dropdown-toggle" data-toggle="dropdown"> <img alt=""
					src="${ctx}/cloud/img/avatars/avatar3.jpg" /> <span class="username">John
		...
		<div id="teamslider">
			<ul class="team-list">
				<li class="current"><a href="javascript:void(0);"> <span
						class="image"> <img src="${ctx}/cloud/img/avatars/avatar3.jpg" alt="" />
			...
			<ul>
				...
				<li class="has-sub"><a href="javascript:;" class=""> <i
					...
					<ul class="sub">
						...
						<li><a class="" href="xcharts.html"><span
								class="sub-menu-text">xCharts</span></a></li>

						<li><a class="" href="others.html"><span
				...
				<li class="has-sub"><a href="javascript:;" class=""> <i
					...
					<ul class="sub">
						<li><a class="" href="mini_sidebar.html"><span
								class="sub-menu-text">Mini Sidebar</span></a></li>
						<li><a class="" href="fixed_header.html"><span
				...
				<li><a class="" href="calendar.html"><i
				...
				<li class="has-sub"><a href="javascript:;" class=""> <i
					...
					<ul class="sub">
						...
						<li><a class="" href="vector_maps.html"><span
								class="sub-menu-text">Vector Maps</span></a></li>
					</ul></li>
				<li><a class="" href="gallery.html"><i
				...
				<li class="has-sub"><a href="javascript:;" class=""> <i
					...
					<ul class="sub">
						...
						<li><a class="" href="user_profile.html"><span
								class="sub-menu-text">User profile</span></a></li>

						<li><a class="" href="chats.html"><span
								class="sub-menu-text">Chats</span></a></li>
						<li><a class="" href="todo_timeline.html"><span
								class="sub-menu-text">Todo & Timeline</span></a></li>
						<li><a class="" href="address_book.html"><span
								class="sub-menu-text">Address Book</span></a></li>

						<li><a class="" href="pricing.html"><span
								class="sub-menu-text">Pricing</span></a></li>
						<li><a class="" href="invoice.html"><span
								class="sub-menu-text">Invoice</span></a></li>
						<li><a class="" href="orders.html"><span
				...
				<li class="has-sub"><a href="javascript:;" class=""> <i
					...
					<ul class="sub">
						...
						<li><a class="" href="error_404.html"><span
						...
						<li><a class="" href="error_500.html"><span
						...
						<li><a class="" href="faq.html"><span
								class="sub-menu-text">FAQ</span></a></li>
						<li><a class="" href="blank_page.html"><span
									...
									<span class="date-range pull-right">
										<div class="btn-group">
											<a class="js_update btn btn-default" href="#">Today</a> <a
												class="js_update btn btn-default" href="#">Last 7 Days</a> <a
												class="js_update btn btn-default hidden-xs" href="#">Last
												...
												<div class="scroller" data-height="450px"
													...
													<div class="feed-activity clearfix">
														<div>
															...
															<a class="user" href="#"> Bob Doe </a> pinned a new photo
															to Pinterest. <br> <a href="#">Take a look</a>
									...
									<div class="scroller" data-height="402px"
										...
										<ul class="media-list chat-list">
											<li class="media"><a class="pull-left" href="#"> <img
													...
													src="${ctx}/cloud/img/chat/headshot1.jpg">
											</a>
											...
											<li class="media"><a class="pull-right" href="#"> <img
													class="media-object" alt="Generic placeholder image"
													src="${ctx}/cloud/img/chat/headshot2.jpg">
											</a>
											...
											<li class="media"><a class="pull-left" href="#"> <img
													class="media-object" alt="Generic placeholder image"
													src="${ctx}/cloud/img/chat/headshot3.jpg">
											</a>
												<div class="media-body chat-pop">
													<h4 class="media-heading">
											...
											<li class="media"><a class="pull-left" href="#"> <img
													class="media-object" alt="Generic placeholder image"
													src="${ctx}/cloud/img/chat/headshot5.jpg">
											</a>
												<div class="media-body chat-pop">
													<h4 class="media-heading">
											...
											<li class="media"><a class="pull-left" href="#"> <img
													class="media-object" alt="Generic placeholder image"
													src="${ctx}/cloud/img/chat/headshot4.jpg">
											</a>
												<div class="media-body chat-pop">
													<h4 class="media-heading">
	...
	<!-- DATE RANGE PICKER -->
	<script src="${ctx}/cloud/js/bootstrap-daterangepicker/moment.min.js"></script>

	<script src="${ctx}/cloud/js/bootstrap-daterangepicker/daterangepicker.min.js"></script>
	<!-- SLIMSCROLL -->
	<script type="text/javascript"
		src="${ctx}/cloud/js/jQuery-slimScroll-1.3.0/jquery.slimscroll.min.js"></script>
	<!-- SLIMSCROLL -->
	<script type="text/javascript"
		src="${ctx}/cloud/js/jQuery-slimScroll-1.3.0/jquery.slimscroll.min.js"></script>
	<script type="text/javascript"
		src="${ctx}/cloud/js/jQuery-slimScroll-1.3.0/slimScrollHorizontal.min.js"></script>
	<!-- BLOCK UI -->
	<script type="text/javascript"
		src="${ctx}/cloud/js/jQuery-BlockUI/jquery.blockUI.min.js"></script>
	<!-- SPARKLINES -->
	<script type="text/javascript"
		src="${ctx}/cloud/js/sparklines/jquery.sparkline.min.js"></script>
	<!-- EASY PIE CHART -->
	<script src="${ctx}/cloud/js/jquery-easing/jquery.easing.min.js"></script>
	<script type="text/javascript"
		src="${ctx}/cloud/js/easypiechart/jquery.easypiechart.min.js"></script>
	<!-- FLOT CHARTS -->
	<script src="${ctx}/cloud/js/flot/jquery.flot.min.js"></script>
	<script src="${ctx}/cloud/js/flot/jquery.flot.time.min.js"></script>
	<script src="${ctx}/cloud/js/flot/jquery.flot.selection.min.js"></script>
	<script src="${ctx}/cloud/js/flot/jquery.flot.resize.min.js"></script>
	<script src="${ctx}/cloud/js/flot/jquery.flot.pie.min.js"></script>
	<script src="${ctx}/cloud/js/flot/jquery.flot.stack.min.js"></script>
	<script src="${ctx}/cloud/js/flot/jquery.flot.crosshair.min.js"></script>
	<!-- TODO -->
	<script type="text/javascript"
		src="${ctx}/cloud/js/jquery-todo/js/paddystodolist.js"></script>
	<!-- TIMEAGO -->
	<script type="text/javascript" src="${ctx}/cloud/js/timeago/jquery.timeago.min.js"></script>
	<!-- FULL CALENDAR -->
	<script type="text/javascript"
		src="${ctx}/cloud/js/fullcalendar/fullcalendar.min.js"></script>
	<!-- COOKIE -->
	<script type="text/javascript"
		src="${ctx}/cloud/js/jQuery-Cookie/jquery.cookie.min.js"></script>
	<!-- GRITTER -->
	<script type="text/javascript"
		src="${ctx}/cloud/js/gritter/js/jquery.gritter.min.js"></script>
	<!-- CUSTOM SCRIPT -->
